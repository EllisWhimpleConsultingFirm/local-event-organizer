    ...
    return (
        <div className="w-full max-w-2xl mx-auto bg-white rounded-xl shadow-lg">
            <div className="p-6 border-b border-gray-200">
                <h2 className="text-2xl font-semibold text-gray-800">Update Event Details</h2>
            </div>
                ...
                <form action={action} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        {state?.errors?.picture && (
                            <p className="mt-2 text-sm text-red-600">{state.errors.picture}</p>
                        )}
                    </div>
            ...
            <div className="pl-6 pr-6 pb-6">
                <DeleteEventForm event={event}></DeleteEventForm>
            </div>
        </div>
    );
}
